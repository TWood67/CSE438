...
void vSerialISRCreateQueues( unsigned portBASE_TYPE, xQueueHandle *, xQueueHandle * );
...
portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
	...
	if (xConsole->iir & 0x02)
	{
		...
		while ( xQueueReceiveFromISR( xCharsForTx, &cChar, &xHigherPriorityTaskWoken ) == pdTRUE && x < 32)
		{
